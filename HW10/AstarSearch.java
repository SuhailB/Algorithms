...
public class AstarSearch {
   ...
   ********************************************************/
    ...
    public static void main(String[] args) {
        ...
        final AstarSearch search = new AstarSearch(adjacency, 1, 1);
    ...
    private static Map<Integer, Set<Neighbor>> createAdjacency() {
        ...
        addAdjacency(adjacency, 2,1,1,3,1); //{2 | 1,3,4,5}
        addAdjacency(adjacency, 3,4,1);         //{3 | 2,5}
        addAdjacency(adjacency, 4,1,1);             //{4 | 2}
        addAdjacency(adjacency, 5,1,1);     //{5 | 1,2,3}
